...
public class Enhancer extends JFrame implements ActionListener , ItemListener , ChangeListener ,MouseMotionListener,MouseListener{
    ...
    int maximageframesize=((int)screenSize.getWidth()*2)/3; //((int)screenSize.getWidth());
    int width=100;
    int height=100;
    int widthbuffer=0;
    int heightbuffer=0;
...
//    BufferedImage bufferimage2 = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
   ...
   // Graphics2D  gracrop= bufferimagedisplay.createGraphics();
     ...
     *
     */
    //public class Enhancer extends JInternalFrame
//{
    public Enhancer() {
      ...
      // JMenuItem variance = new JMenuItem("Variance");
       ...
       JMenuItem decrypt = new JMenuItem("Decrypt");
        ...
        dp.setBackground(colorsel1);
        dp.setAutoscrolls(imageopen);
        dp.setPreferredSize(screenSize);
        dp.add(imgfrm);
...
//}
    ...
    public imageframe()
    {
     ...
     //imageframe.add(jlabel3);
        ...
        JPanel jp=new JPanel(resizable);
       
        
        
        setClosable(true);
        jp.setLayout(new BorderLayout());
        //jp.add(new JLabel("Sanchit"));
        //jlabel3= new JLabel("Sanchit");
        jlabel1 = new JLabel("",new ImageIcon(""),JLabel.LEFT);
        jp.add(jlabel1,BorderLayout.NORTH);
        jlabel3 = new JLabel("",new ImageIcon(""),JLabel.LEFT);

        jp.add(jlabel3,BorderLayout.SOUTH);
   ...
   if(action=="Show Info"){
    ...
    //jlabel3.setText("Sanchit");
    //imageframe.setResizable(false);
    //imageframe.pack();
    //if(!dialogopen&&!otherframeopen)
        imgfrm.setVisible(true);
        //imgfrm.setLayout(new BorderLayout());
        imgfrm.setMaximizable(true);
        imgfrm.repaint();
    frame.pack();
    frame.setVisible(true);
